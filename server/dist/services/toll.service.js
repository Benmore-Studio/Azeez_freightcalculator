...
export const FREIGHT_VEHICLE_MAP = {
    semi: '5axle',
    box_truck: '2axle',
    cargo_van: '2axle',
    sprinter: '2axle',
 ...
 */
function parseTollGuruResponse(data) {
    try {
 ...
 */
function generateCacheKeys(input) {
 ...
 */
function getAxleCount(vehicleType) {
    const axleCounts = {
        car: 2,
        '2axle': 2,
        '3axle': 3,
 ...
 */
async function getCachedTolls(input) {
    try {
 ...
 */
async function cacheTolls(breakdown, input) {
    try {
 ...
 */
export function estimateTollsFallback(distanceMiles, statesCrossed) {
    // Average toll rates per mile by state (approximate)
    const STATE_TOLL_RATES = {
        // High toll states
        NJ: 0.15,
        NY: 0.12,
        PA: 0.10,
...
//# sourceMappingURL=toll.service.js.map