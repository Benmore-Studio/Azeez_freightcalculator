 ...
 */
export async function generateQuotePDF(data, options = {}) {
    ...
    // Helper to draw text
    const drawText = (text, x, y, size, font = helvetica, color = COLORS.gray900) => {
        page.drawText(text, { x, y, size, font, color });
    };
    // Helper to draw a horizontal line
    const drawLine = (y, color = COLORS.gray200) => {
        page.drawLine({
            start: { x: MARGIN, y },
