 ...
 */
export async function calculateRate(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    ...
    const result = await quoteService.previewRate(userId, validatedData as any);
 ...
 * POST /api/quotes
 */
export async function createQuote(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
    ...
    const validatedData = calculateRateSchema.parse(req.body);
    const result = await quoteService.createQuote(userId, validatedData as any);
 ...
 * GET /api/quotes
 */
export async function getQuotes(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
 ...
 */
export async function updateQuoteStatus(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
    ...
    const quote = await quoteService.updateQuoteStatus(userId, req.params.id, statusResult.data as any);
 ...
 */
export async function deleteQuote(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
 ...
 */
export async function getRecentQuotes(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
 ...
 */
export async function getQuoteStats(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const userId = req.user?.userId;
    if (!userId) {
      throw new ApiError(401, 'Unauthorized');
