 ...
 * Get a quote by ID
 */
export async function getQuoteById(userId: string, quoteId: string) {
 ...
 * Update quote status
 */
export async function updateQuoteStatus(userId: string, quoteId: string, status: QuoteStatus) {
  const quote = await prisma.quote.findFirst({
